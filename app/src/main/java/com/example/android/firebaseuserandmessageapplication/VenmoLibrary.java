package com.example.android.firebaseuserandmessageapplication; //Replace this with the name of your package
...
public class VenmoLibrary {
    ...
    public VenmoResponse validateVenmoPaymentResponse(String signed_payload, String app_secret) {
        Log.d("venmo_library", "validateVenmoPaymentResponse");
